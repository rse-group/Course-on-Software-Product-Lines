...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\begin{fancycolumns}[t,columns=4,animation=none]
		\mydefinition{\emphifequal{#1}{I}{Part I: Ad-Hoc Approaches for Variability}}{
			\begin{enumerate}
				...
				\item {\emphifequal{#1}{2.1}{Runtime Variability and Design Patterns}}
				\item {\emphifequal{#1}{2.2}{Compile-Time Variability with Clone-and-Own}}
			\end{enumerate}
		}
	\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part II: Modeling \& Implementing Features}}{
			\begin{enumerate}
				\setcounter{enumi}{3}
				\item {\emphifequal{#1}{3}{Feature Modeling}}
				\item {\emphifequal{#1}{3.2}{Conditional Compilation}}
				\item {\emphifequal{#1}{4.1}{Modular Features}}
				\item {\emphifequal{#1}{4.2}{Languages for Features}}
				\item {\emphifequal{#1}{5.1}{Development Process}}
				\item {\emphifequal{#1}{5.2}{Delta-Oriented Programming}}
	...
	\nextcolumn
		...
		\mydefinition{\emphifequal{#1}{III}{Part III: Web Based Product Line Development}}{
			\begin{enumerate}
				\setcounter{enumi}{6}
				\item {\emphifequal{#1}{6.1}{Variability Modules for Java}}
				\item {\emphifequal{#1}{6.1}{UML-DOP Profile}}
				\item {\emphifequal{#1}{6.2}{IFML-DOP Extension}}
				\item {\emphifequal{#1}{7}{Model-driven SPLE for Web Development}}
				\item {\emphifequal{#1}{8}{Web Framework for SPLE}}
				\item {\emphifequal{#1}{9}{User Interface Development for SPLE}}
			\end{enumerate}
		}}
	\nextcolumn
		...
		%	\item {\emphifequal{#1}{9}{Feature Interactions}}
			...
			\unlessuniversity{wernigerode, indonesia}{
