...
\definecolor{lecturered}{RGB}{217,95,2}
\definecolor{lecturegreen}{RGB}{27,158,119}
\definecolor{lectureblue}{RGB}{117,112,179}
...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\begin{fancycolumns}[t,columns=4,animation=none]
		\mydefinition{\emphifequal{#1}{I}{Part I: Ad-Hoc Approaches for Variability}}{
			\begin{enumerate}
				\item {\emphifequal{#1}{1}{Introduction}}
				\item [2.1] {\emphifequal{#1}{2}{Runtime Variability and Design Patterns}}
				\item [2.2] {\emphifequal{#1}{3}{Compile-Time Variability with Clone-and-Own}}
			\end{enumerate}
		}
	\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part II: Modeling \& Implementing Features}}{
			\begin{enumerate}
				\setcounter{enumi}{3}
				\item [3.1] {\emphifequal{#1}{4}{Feature Modeling}}
				\item [3.2]{\emphifequal{#1}{5}{Conditional Compilation}}
				\item [4.1]{\emphifequal{#1}{6}{Modular Features}}
				\item [4.2]{\emphifequal{#1}{7}{Languages for Features}}
				\item [5.1]{\emphifequal{#1}{8}{Development Process}}
				\item [5.2]{\emphifequal{#1}{9}{Delta-Oriented Programming}}

			\end{enumerate}
		}
	\nextcolumn
    	\ifuniversity {indonesia}{
		\mydefinition{\emphifequal{#1}{III}{Part III: Web Based Product Line Development}}{
			\begin{enumerate}
				\setcounter{enumi}{6}
				\item [6.1] {\emphifequal{#1}{11}{Variability Modules for Java}}
				\item [6.2] {\emphifequal{#1}{12}{UML-DOP Profile}}
				\item [6.3]{\emphifequal{#1}{13}{IFML-DOP Extension}}
				\item [7]{\emphifequal{#1}{14}{Model-driven SPLE for Web Development}}
				\item [8.1]{\emphifequal{#1}{15}{Web Framework for SPLE}}
				\item [8.2]{\emphifequal{#1}{16}{User Interface Development for SPLE}}
			\end{enumerate}
		}}
	\nextcolumn
		    \mydefinition{\emphifequal{#1}{IV}{Part IV: Quality Assurance and Outlook}}{
		\begin{enumerate}
			\setcounter{enumi}{8}
			\unlessuniversity{indonesia}{
			\item {\emphifequal{#1}{17}{Feature Interactions}}
			}
			\item {\emphifequal{#1}{17}{Product-Line Analyses}}
...
%		
			...
			\ifuniversity{wernigerode}{
				\item {\emphifequal{#1}{14}{Cost Estimation}}
			}
		\end{enumerate}
	}
	\end{fancycolumns}
...
\newcommand{\fs}[1]{\ensuremath{{\color{lecturegreen}#1}}} % selected feature
\newcommand{\fd}[1]{\ensuremath{{\color{lecturered}#1}}} % deselected feature
\newcommand{\clause}[1]{\ensuremath{{\color{lecturered}#1}}} % clause in a CNF
\newcommand{\cfg}[3][0]{\ensuremath{({\only<#1>{\color{lecturegreen}}\{#2\}}, {\only<#1>{\color{lecturered}}\{#3\}})}} % configuration


\let\oldtop\top
\renewcommand{\top}{\ensuremath{\boldsymbol{\oldtop}}}
\let\oldbot\bot
\renewcommand{\bot}{\ensuremath{\boldsymbol{\oldbot}}}
