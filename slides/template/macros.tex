...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part II: Modeling \& Implementing Features}}{
			\begin{enumerate}
				...
				\ifuniversity{indonesia}{\item {\emphifequal{#1}{9}{Delta-Oriented Programming}}}
			\end{enumerate}
		}
	...
	\nextcolumn
		\mydefinition{\emphifequal{#1}{III}{Part III: Web Based Product Line Development}}{
			\begin{enumerate}
				\setcounter{enumi}{9}
				\item {\emphifequal{#1}{10}{Variability Modules for Java}}
				\item {\emphifequal{#1}{11}{UML-DOP Profile}}
				\item {\emphifequal{#1}{12}{IFML-DOP Extension}}
				\item {\emphifequal{#1}{13}{Model-driven SPLE for Web Development}}
				\item {\emphifequal{#1}{14}{Web Framework for SPLE}}
				\item {\emphifequal{#1}{15}{User Interface Development for SPLE}}
			\end{enumerate}
		}
	}
	% TODO: Make separate QA & Outlook part for UI in the Indonesia condition
	%       That is, create a copy of the next column section into the ifuniversity block
	%       Then, preserve the original, non-Indonesia, from the upstream
	\nextcolumn
		\mydefinition{
			\ifuniversity[{
				\emphifequal{#1}{IV}{Part III: Quality Assurance and Outlook}
				\setcounter{enumi}{8}
			}]{indonesia}{
				\emphifequal{#1}{IV}{Part IV: Quality Assurance and Outlook}
				\setcounter{enumi}{15}
			}
		}{
		\begin{enumerate}
