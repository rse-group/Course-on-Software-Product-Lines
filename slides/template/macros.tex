...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\nextcolumn
		...
		\mydefinition{\emphifequal{#1}{III}{Part III: Web Based Product Line Development}}{
			\begin{enumerate}
				\setcounter{enumi}{6}
				\item [6.1] {\emphifequal{#1}{12}{UML-DOP Profile}}
				\item [6.2] {\emphifequal{#1}{11}{Variability Modules for Java}}
				\item [7.1]{\emphifequal{#1}{14}{Model-driven SPLE and WinVMJ}}
				\item [7.2]{\emphifequal{#1}{16}{User Interface Development for SPLE}}
			\end{enumerate}
		}}
	\nextcolumn
