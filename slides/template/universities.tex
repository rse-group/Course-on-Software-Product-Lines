...
\ifuniversity{indonesia}{\title{Software Product Line Engineering}}
...
\renewcommand{\author}[1]{
	...
	\ifuniversity{indonesia}{\author@old{Maya R.A. Setyautami}}
...
\ifuniversity{indonesia}{
	\AtEndPreamble{ % copied from https://github.com/sp-uulm/FancyBeamerUULM/blob/main/fancyuulm.sty
		...
		\definecolor{accent}{HTML}{ED1C24}
		\colorlet{accenttwo}{blue} % specify faculty color here: red, green, blue, orange
