...
\begin{frame}{What do these examples have in common?}
	\begin{fancycolumns}[columns=3,widths={35,28},animation=none]
		\ifuniversity{indonesia}{\pic[width=\linewidth]{wedding-id}}[\pic[width=\linewidth]{wedding}]
...
\begin{frame}{What is a Feature?}
	\begin{fancycolumns}[widths={45},t]
		\uncover<2->{\begin{definition}{Feature  \mysource{\fospl\mypage{18}}}
	...
	\nextcolumn
		\uncover<3->{\begin{note}{Feature in a Product Line \mysource{\fospl\mypage{18}}}
			...
			\begin{itemize}
				\item to specify and communicate commonalities and differences of the products between stakeholders and
