...
\subtitle{Title Slide}  % could also be a conference name

\date{}

\author[Initial] % optional, use only with lots of authors
{
  Name\\
  \href{mailto:name@cs.ui.ac.id}{{\tt name@cs.ui.ac.id}}
}
