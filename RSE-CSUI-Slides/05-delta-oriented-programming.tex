...
\title[FunPro 2022]% optional, use only with long paper titles
{Pemrograman Fungsional 2022}

\subtitle{Simply Typed $\lambda$ Calculus}  % could also be a conference name

\date{Rabu, 23 Oktober 2022}

\author[AA] % optional, use only with lots of authors
{
  Ade Azurat\\
  \href{mailto:ade@cs.ui.ac.id}{{\tt ade@cs.ui.ac.id}}
}
