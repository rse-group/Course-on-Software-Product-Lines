...
\newcommand{\contentoverviewindo}{
	\begin{frame}[plain]
		\label{lecture\insertlecturenumber}
		\setbeamerfont{section in toc}{size=\small}\setbeamerfont{subsection in toc}{size=\footnotesize}
		\begin{beamercolorbox}[wd=.95\paperwidth,ht=38ex,dp=2ex]{lectureseries}
			{\footnotesize\lectureseriesoverview[\insertlecturenumber]}
		\end{beamercolorbox}
		\centering \LARGE\textbf{\inserttitle}
		\begin{beamercolorbox}[wd=\paperwidth,ht=4.5ex,dp=2ex,center]{logobox}
			\vspace{-1ex}%
			\hspace{10pt}
			\fancy@logoline
			\hspace{10pt}
